...
public class EntityClassGenerator<E> implements CustomFieldGenerator<E>
{
	...
	private String displayName(Class<?> cls)
	{
		...
		if( !clsName.startsWith("net.driftingsouls.ds2.net.driftingsouls.ds2.interfaces.server.") )
		{
			return clsName;
		}
		return clsName.substring("net.driftingsouls.ds2.net.driftingsouls.ds2.interfaces.server.".length());
	}
