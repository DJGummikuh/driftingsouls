#!/usr/bin/env bash
apt-get update
sudo debconf-set-selections <<< 'mysql-net.driftingsouls.ds2.interfaces.server mysql-net.driftingsouls.ds2.interfaces.server/root_password password 12345'
sudo debconf-set-selections <<< 'mysql-net.driftingsouls.ds2.interfaces.server mysql-net.driftingsouls.ds2.interfaces.server/root_password_again password 12345'
apt-get install -y mysql-net.driftingsouls.ds2.interfaces.server ant
