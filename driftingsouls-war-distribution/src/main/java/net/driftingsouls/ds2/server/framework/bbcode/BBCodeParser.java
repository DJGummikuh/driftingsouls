 ...
 * Datei <code>META-INF/services/net.driftingsouls.ds2.net.driftingsouls.ds2.interfaces.server.framework.bbcode.BBCodeFunction</code>
...
public class BBCodeParser {
	...
	private BBCodeParser() {
		try {
			...
			// Weitere BBCodes aus META-INF/services/net.driftingsouls.ds2.net.driftingsouls.ds2.interfaces.server.framework.bbcode.BBCodeFunction lesen
